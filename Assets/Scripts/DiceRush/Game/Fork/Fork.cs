...
namespace StepanoffGames.DiceRush.Game
{
	public class Fork : MonoBehaviour
	{
		...
		public async UniTask<int> SelectNextDirectionForPoint(MapPoint point, PlayerAvatar player)
		{
		...
		public async UniTask<int> SelectPrevDirectionForPoint(MapPoint point, PlayerAvatar player)
		{
			transform.position = point.transform.position;
